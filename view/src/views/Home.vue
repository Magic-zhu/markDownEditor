  ...
  <div class="wrapper" @click="ifShowMenu=false">
    ...
    <div class="home">
      ...
      <div class="content" :style="content_style">
        ...
        <div class="right_side" v-html="result" v-if="view==1||view==2" :style="right_side_style"></div>
      </div>
    </div>
    <!--右键菜单-->
...
export default {
  ...
  mounted() {
    ...
    Editor.onDidChangeModelContent(()=>{
      this.result = md.render(Editor.getValue())
    })
    //监听主进程的消息
  ...
  methods: {
    ...
    replaceSelectedWords(a, b) {
      let selectString = Editor.getSelection();
